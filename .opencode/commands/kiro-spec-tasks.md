...
- **Clarification Loop**: If task ordering, dependencies, or coverage are unclear, use the `question` tool with option-based prompts and continue until all generation blockers are resolved.
  </instructions>
