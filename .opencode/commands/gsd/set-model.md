...
Unlike `/gsd-set-profile` which switches between profiles, this command lets you define _what models_ a profile uses. Implementation lives in the `gsd-set-model` agent.
</objective>
