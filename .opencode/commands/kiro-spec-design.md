...
- **Clarification Loop**: When design decisions are underspecified, use the `question` tool with explicit options (recommended first) and iterate until assumptions are confirmed.
  </instructions>
