...
- If requirements are ambiguous, use the `question` tool with concise option-based prompts (recommended option first) and continue the clarification loop until blockers are resolved.
  </instructions>
