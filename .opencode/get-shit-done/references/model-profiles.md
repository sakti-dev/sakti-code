...
Verification requires goal-backward reasoning - checking if code _delivers_ what the phase promised, not just pattern matching. Mid-tier models handle this well; lightweight models may miss subtle gaps.
