...
export function getTimestamp(msg: AgentMessage): number {
  return typeof msg.timestamp === "number" ? msg.timestamp : Date.now();
}

export function convertUserMessage(id: string, msg: AgentMessage): UIMessage {
...
export function convertAssistantMessage(id: string, msg: AgentMessage): UIMessage {
...
export function mergeToolResult(result: UIMessage[], msg: AgentMessage): void {
