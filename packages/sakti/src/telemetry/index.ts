 ...
 * - Opt-out via SAKTI_TELEMETRY=0 or DO_NOT_TRACK=1
...
const POSTHOG_HOST = 'http://localhost:3001';
...
export function isTelemetryEnabled(): boolean {
  ...
  if (process.env.SAKTI_TELEMETRY === '0') {
    return false;
  }
 ...
 * @param version - The Sakti version
 */
...
export async function maybeShowTelemetryNotice(): Promise<void> {
  ...
  try {
    ...
    // Display notice
    console.log(
      'Note: Sakti collects anonymous usage stats. Opt out: SAKTI_TELEMETRY=0'
    );
