...
Applies to tests under `src/**/__tests__/`.

## Running Tests

- Focused file: `pnpm exec vitest run src/sdd/<dir>/__tests__/file.test.ts`
- Focused case: `pnpm exec vitest run src/sdd/<dir>/__tests__/file.test.ts -t "case name"`
