...
export function getFeedbackSkillTemplate(): SkillTemplate {
  return {
    name: 'feedback',
    description: 'Collect and submit user feedback about Sakti with context enrichment and anonymization.',
    instructions: `Help the user submit feedback about Sakti.
...
5. **Submit on confirmation**
   - Use the \`sakti feedback\` command to submit
   - Format: \`sakti feedback "title" --body "body content"\`
