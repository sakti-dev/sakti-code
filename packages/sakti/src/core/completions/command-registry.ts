...
export const COMMAND_REGISTRY: CommandDefinition[] = [
  ...
  },
  {
    ...
    flags: [
      ...
      {
        name: 'concurrency',
        description: 'Max concurrent validations (defaults to env SAKTI_CONCURRENCY or 6)',
        takesValue: true,
      },
  ...
  {
    name: 'context',
    description: 'Print the working context for the resolved Sakti root',
    flags: [
      COMMON_FLAGS.json,
      COMMON_FLAGS.store,
      {
  ...
  {
    name: 'doctor',
    description: 'Report relationship health for the resolved Sakti root',
    flags: [
      COMMON_FLAGS.json,
      COMMON_FLAGS.store,
    ],
  ...
  {
    name: 'change',
    description: 'Manage Sakti change proposals (deprecated)',
    flags: [],
    subcommands: [
      {
        name: 'show',
  ...
  {
    name: 'spec',
    description: 'Manage Sakti specifications',
    flags: [],
    subcommands: [
      {
        name: 'show',
