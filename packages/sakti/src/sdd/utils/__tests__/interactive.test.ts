...
describe("interactive utilities", () => {
  ...
  beforeEach(() => {
    ...
    originalSaktiInteractive = process.env.OPEN_SPEC_INTERACTIVE;
  ...
  afterEach(() => {
    ...
    if (originalSaktiInteractive !== undefined) {
      process.env.OPEN_SPEC_INTERACTIVE = originalSaktiInteractive;
    } else {
      delete process.env.OPEN_SPEC_INTERACTIVE;
    }
