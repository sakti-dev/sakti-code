...
echo "======================================"
echo "Testing Sakti Postinstall Script"
echo "======================================"
echo ""

# Save original environment
ORIGINAL_CI="${CI:-}"
ORIGINAL_SAKTI_NO_COMPLETIONS="${SAKTI_NO_COMPLETIONS:-}"

# Test 1: Normal install
echo "Test 1: Normal install (should print tip about completions)"
echo "--------------------------------------"
unset CI
unset SAKTI_NO_COMPLETIONS
...
echo "Test 3: SAKTI_NO_COMPLETIONS=1 (should skip silently)"
echo "--------------------------------------"
unset CI
export SAKTI_NO_COMPLETIONS=1
node scripts/postinstall.js
...
if [ -n "$ORIGINAL_SAKTI_NO_COMPLETIONS" ]; then
  export SAKTI_NO_COMPLETIONS="$ORIGINAL_SAKTI_NO_COMPLETIONS"
else
  unset SAKTI_NO_COMPLETIONS
fi
