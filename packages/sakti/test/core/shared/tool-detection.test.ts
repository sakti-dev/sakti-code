...
describe('tool-detection', () => {
  ...
  describe('SKILL_NAMES', () => {
    it('should contain all skill names matching COMMAND_IDS', () => {
      ...
      expect(SKILL_NAMES).toContain('sakti-explore');
      expect(SKILL_NAMES).toContain('sakti-new-change');
      expect(SKILL_NAMES).toContain('sakti-continue-change');
      expect(SKILL_NAMES).toContain('sakti-apply-change');
      expect(SKILL_NAMES).toContain('sakti-ff-change');
      expect(SKILL_NAMES).toContain('sakti-sync-specs');
      expect(SKILL_NAMES).toContain('sakti-archive-change');
      expect(SKILL_NAMES).toContain('sakti-bulk-archive-change');
      expect(SKILL_NAMES).toContain('sakti-verify-change');
      expect(SKILL_NAMES).toContain('sakti-onboard');
      expect(SKILL_NAMES).toContain('sakti-propose');
    });
  });
  ...
  describe('getToolSkillStatus', () => {
    ...
    it('should detect when one skill exists', async () => {
      const skillDir = path.join(testDir, '.claude', 'skills', 'sakti-explore');
