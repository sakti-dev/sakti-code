...
describe('FishGenerator', () => {
  ...
  describe('generate', () => {
    it('should generate valid fish completion script with header', () => {
      ...
      expect(script).toContain('# Fish completion script for Sakti CLI');
      expect(script).toContain('function __fish_sakti');
    });
    ...
    it('should generate helper functions for Fish', () => {
      ...
      expect(script).toContain('function __fish_sakti_using_subcommand');
      expect(script).toContain('function __fish_sakti_no_subcommand');
    ...
    it('should include all commands with descriptions', () => {
      ...
      expect(script).toContain("complete -c sakti");
      expect(script).toContain("-a 'init'");
      expect(script).toContain("'Initialize Sakti'");
    ...
    it('should handle commands with subcommands', () => {
      ...
      expect(script).toContain("__fish_sakti_using_subcommand change");
    });
    ...
    it('should handle positional arguments for change-id', () => {
      ...
      expect(script).toContain('__fish_sakti_changes');
    });
    ...
    it('should handle positional arguments for spec-id', () => {
      ...
      expect(script).toContain('__fish_sakti_specs');
    });
    ...
    it('should handle positional arguments for change-or-spec-id', () => {
      ...
      expect(script).toContain('__fish_sakti_items');
    });
    ...
    it('should handle positional arguments for schema names', () => {
      ...
      expect(script).toContain('__fish_sakti_schemas');
      expect(script).toContain('sakti __complete schemas 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for changes', () => {
      ...
      expect(script).toContain('function __fish_sakti_changes');
      expect(script).toContain('sakti __complete changes 2>/dev/null');
    ...
    it('should generate dynamic completion helper for specs', () => {
      ...
      expect(script).toContain('function __fish_sakti_specs');
      expect(script).toContain('sakti __complete specs 2>/dev/null');
    });
    ...
    it('should generate dynamic completion helper for items', () => {
      ...
      expect(script).toContain('function __fish_sakti_items');
      expect(script).toContain('__fish_sakti_changes');
      expect(script).toContain('__fish_sakti_specs');
    });
