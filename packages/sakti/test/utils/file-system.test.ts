...
describe('FileSystemUtils', () => {
  ...
  describe('joinPath', () => {
    ...
    it('should join Windows drive-letter paths with backslashes', () => {
      ...
      expect(result).toBe(
        'C:\\Users\\dev\\project\\.claude\\commands\\sakti\\proposal.md'
      );
    });
    ...
    it('should join Windows paths that use forward slashes', () => {
      ...
      expect(result).toBe(
        'D:\\workspace\\app\\.cursor\\commands\\sakti-apply.md'
      );
    });
    ...
    it('should join UNC-style Windows paths', () => {
      ...
      expect(result).toBe(
        '\\server\\share\\repo\\.windsurf\\workflows\\sakti-archive.md'
      );
    });
  });
});
