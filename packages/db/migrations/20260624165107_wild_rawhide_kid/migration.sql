...
INSERT INTO `__new_sessions`(`id`, `project_id`, `parent_session_id`, `title`, `model_id`, `kind`, `thinking_level`, `leaf_id`, `created_at`, `updated_at`) SELECT `id`, `project_id`, `parent_session_id`, `title`, `model_id`, `kind`, `thinking_level`, `leaf_id`, `created_at`, `updated_at` FROM `sessions`;--> statement-breakpoint
