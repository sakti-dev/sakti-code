/**
 * Tool argument validation against TypeBox schemas.
 *
 * Ported from pi-ai's `validation.ts` — it's agent-side tool execution
 * logic, not LLM knowledge. Validates and coerces tool call arguments
 * from the LLM into the types the tool schema expects.
 */
