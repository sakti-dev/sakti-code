 ...
 * Returns null if the image cannot be resized below maxBytes, or if Photon
 * (Rust/WASM) is unavailable.
 *
 * Strategy for staying under maxBytes:
 * 1. Resize to maxWidth/maxHeight.
 * 2. Try PNG and a ladder of JPEG qualities; pick the smallest under budget.
 * 3. If still too large, shrink dimensions by 0.75x and retry until 1x1.
 */
